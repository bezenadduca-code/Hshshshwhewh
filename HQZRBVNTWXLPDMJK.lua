...
ui:AddTheme({
    ...
    ToggleBar       = Color3.fromHex("#E8194B"),
...
------------------------------------------------------------------------
------------------------------------------------------------------------
local tabUpdateLogs = win:Tab({ Title = "Update Logs", Icon = "newspaper", IconColor = Color3.fromHex("#FFD700"), ShowTabTitle = false })
